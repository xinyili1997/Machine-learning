...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $\frac{405}{1024}$
        \item $\circle$ $\frac{1}{32}$
        \item $\circle$ $\frac{324}{1024}$
...
\clearpage
    ...
    \begin{list}{}
        ...
        \item $\circle$ $p, p(1-p),\log(1-p)-p\log(p)$
...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $8x^3-3x^2+5$
        \item $\circle$ $8x^4-3x^3+5x$
        \item $\circle$ $6x^3-2x^2$
        \item $\circle$ $16x^3-x^2+5$
    \end{list}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $3x\sin(z) e^{-x}(2+x)$
        \item $\circle$ $-6x\sin(z) e^{-x}$
        \item $\circle$ $3x\sin(z) e^{-x}(2-x)$
        \item $\circle$ $6x\cos(z)e^{-x}$
    \end{list}
...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $\begin{bmatrix} 4 & 6 \\ 2 & 3 \end{bmatrix}$
        \item $\circle$ 9
        \item $\circle$ $\begin{bmatrix} 4 \\ 3 \end{bmatrix}$
        \item $\circle$ 7
    \end{list}
...
What is the product $\mathbf{AB}$?
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $ \begin{bmatrix} 13 & 19 & 5 \\ -3 & -14 & -9 \\ 4 & -4 & 18 \end{bmatrix} $
        \item $\circle$ $ \begin{bmatrix} 13 & 19 & 28 \\ 19 & 9 & -7 \\ -10 & -2 & 13 \end{bmatrix} $
        \item $\circle$ $ \begin{bmatrix} 20 & -20 & -28 \\ 3 & -14 & 9 \\ 3 & 2 & 13 \end{bmatrix} $
...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ The inner product $\mathbf{w^T(x' - x'')}$, where $\mathbf{x'}$ and $\mathbf{x''}$ are two points on the line $\mathbf{w^Tx}+b=0$, is 0
        \item $\circle$ The inner product $\mathbf{w^T(x' - x'')}$, where $\mathbf{x'}$ and $\mathbf{x''}$ are two points on the line $\mathbf{w^Tx}+b=0$, is 1
        \item $\circle$ The inner product $\mathbf{w^T(x' - x'')}$, where $\mathbf{x'}$ and $\mathbf{x''}$ are two points on the line $\mathbf{w^Tx}+b=0$, is $b' - b''$
    \end{list}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $\frac{|b|}{||\mathbf{w}||}$
        \item $\circle$ $\frac{|b|}{\mathbf{w^Tw}}\mathbf{w}$
        \item $\circle$ $\frac{2\lambda}{\mathbf{w}b}$
        \item $\circle$ $\frac{||\mathbf{w}||}{|b|}$
    \end{list}
...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ $f(n) \in O(g(n))$
        \item $\circle$ $g(n) \in O(f(n))$
        \item $\circle$ Both 
        \item $\circle$ Neither
    \end{list}
